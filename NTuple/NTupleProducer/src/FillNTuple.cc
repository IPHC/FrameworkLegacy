...
void FillNTuple::Fill(const IPHCTree::MTEvent* minitree, IPHCTree::NTEvent* ntuple)
{
  ...
  // Electrons
  // -------------------------------------
  if (!skimElectrons) std::cout << "Filling electrons (no skim) ..." << std::endl;
  ...
  // Photons
  // -------------------------------------
  if (!skimPhotons) std::cout << "Filling photons (no skim) ..." << std::endl;
  ...
  // Muons
  // -------------------------------------
  if (!skimMuons) std::cout << "Filling muons (no skim) ..." << std::endl;
  ...
  // Taus
  // -------------------------------------
  if (!skimTaus) std::cout << "Filling taus (no skim) ..." << std::endl;
  ...
  // Jets
  // -------------------------------------
  if (!skimJets) std::cout << "Filling jets (no skim) ..." << std::endl;
  ...
  // Met
  // -------------------------------------
  if (!skimJets) std::cout << "Filling met (no skim) ..." << std::endl;
  ...
  // Tracks
  // -------------------------------------
  if (!skimTracks) std::cout << "Filling tracks (no skim) ..." << std::endl;
  ...
  // Vertices
  // -------------------------------------
  if (!skimVertices) std::cout << "Filling vertices (no skim) ..." << std::endl;
