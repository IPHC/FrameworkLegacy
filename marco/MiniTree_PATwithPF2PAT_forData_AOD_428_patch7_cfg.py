...
#process.GlobalTag.globaltag = cms.string('FT_R_42_V13A::All') # May10ReReco
#process.GlobalTag.globaltag = cms.string('GR_P_V22A::All') # PromptReco
#process.GlobalTag.globaltag = cms.string('FT_R_42_V20A::All') # Aug5
# pour avoir les bons JES corr
...
#  Define the Path
####################################
process.p = cms.Path( #process.totalKinematicsFilter* ## no filter on mc infos for data !
...
process.source = cms.Source(
    ...
    fileNames = cms.untracked.vstring(
      'file:/home/jlagram/scratch/data/Run2011A_PromptReco-v4.root'
